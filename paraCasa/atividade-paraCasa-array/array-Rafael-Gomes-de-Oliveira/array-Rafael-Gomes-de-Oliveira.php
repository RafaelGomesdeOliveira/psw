...
<?php
    ...
    foreach ($aluno as $materia => $notas) {
        ...
        echo "Media: <strong>$media</strong>" . "<br>";

        echo "Nota final: <strong>$valorObtido</strong>" . "<br>" . "<br>";

        if ($valorObtido >= 60){
            echo "<strong>Parabéns, você conseguiu passar nessa disciplina!!!</strong>" . "<br>" . "<br>";
        }
        else {
    ...
    //Imprimindo a nota de apenas uma disciplina
    foreach ($aluno as $materia => $notas) {
